...
def make_dataset(annotation_path, audio_path, gt_path, vox=False):
    ...
    for i in range(len(video_names)):
        ...
        [audiowav, Fs] = torchaudio.load(
            audio_wav_path, normalize=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--save_path', default='/ssd_scratch/cvit/varunc/Results/AViNet_Diem', type=str)
    parser.add_argument('--start_idx', default=-1, type=int)
    parser.add_argument('--num_parts', default=4, type=int)
    parser.add_argument('--split', default=1, type=int)
    parser.add_argument(
        '--path_indata', default='/ssd_scratch/cvit/varunc/data/', type=str)
